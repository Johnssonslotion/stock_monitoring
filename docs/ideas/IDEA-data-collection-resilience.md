...
**구현 위치**: [`src/monitoring/sentinel.py`](file:///Users/bbagsang-u/workspace/stock_monitoring/src/monitoring/sentinel.py)
...
**구현 위치**: [`scripts/operations/preflight_check.py`](file:///Users/bbagsang-u/workspace/stock_monitoring/scripts/operations/)
...
### Target Components
1. **Unified Collector** ([`src/data_ingestion/price/unified_collector.py`](file:///Users/bbagsang-u/workspace/stock_monitoring/src/data_ingestion/price/unified_collector.py))
   - Circuit Breaker 로직 추가
   
2. **Sentinel Service** ([`src/monitoring/sentinel.py`](file:///Users/bbagsang-u/workspace/stock_monitoring/src/monitoring/sentinel.py))
   - Watchdog 기능 확장
   
3. **History Loader** ([`src/data_ingestion/history/loader.py`](file:///Users/bbagsang-u/workspace/stock_monitoring/src/data_ingestion/history/loader.py))
   - Gap-Filler 로직 통합
...
- [Idea: 2026-01-19 Collection Failure Analysis](../ARCHIVE/ideas/ID-2026-01-19-collection-failure.md)
- [Kiwoom API Access Diagnosis](../ARCHIVE/ideas/ID-2026-01-19-kiwoom-access-diagnosis.md)
- [Development Governance](../governance/development.md)
- [Collector Failure Runbook](../operations/runbooks/collector-failures.md)
