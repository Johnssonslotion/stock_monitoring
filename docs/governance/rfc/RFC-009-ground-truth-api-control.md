...
### Phase 4: 검증 (Week 3)
- [ ] Rate Limit 테스트 (멀티 워커 환경)
- [ ] **Container-based E2E Verification**: 실제 운영 포트 모사 테스트
- [ ] **Self-Diagnosis Unit Test**: 환경변수 누락 시 Fail-Fast 확인
- [ ] Ground Truth 정책 검증 (샘플 백테스트)
- [ ] 1주일 파일럿 운영
...
**Next Steps**: Phase 2 실행 (BackfillManager 및 RecoveryOrchestrator gatekeeper 통합)
