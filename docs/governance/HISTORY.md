...
| **2026-01-29** | **2.21** | **Market Intelligence & Rotation (Pillar 8)**<br>- 수급/공매도 분석 기반 '순환매 탐지' 로드맵 신설<br>- KIS Investor/Short Selling TR 명세 및 DB 스킨마 확정 | [Pillar 8](../strategy/master_roadmap.md)<br>[ISSUE-049](../issues/ISSUE-049.md) |
| **2026-01-31** | **2.22** | **Advanced Data Pipeline (ISSUE-053)**<br>- 10단계 호가 스트리밍, Whale 감지, DB 압축<br>- **Process**: TDD 검증(Spec+Test+Mock) 후 승인 (Test-First) | [ISSUE-053](../issues/ISSUE-053.md) |
