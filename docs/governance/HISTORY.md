...
| **2026-01-28** | **2.19** | **Flat Aggregation Architecture**<br>- Cascade → Flat Aggregation Strategy 변경 (Deploy Stability)<br>- RealtimeVerifier와 Recovery Pipeline 통합 (ISSUE-044) | [ISSUE-044](../issues/ISSUE-044.md)<br>[Gap Analysis](../gap_analysis_report_2026-01-28.md) |
| **2026-01-29** | **2.20** | **Automated Deployment Verification**<br>- 배포 후 Log Scan 의무화 (RFC-006)<br>- `/deploy-production` 워크플로우 도입<br>- Silent Failure 방지 및 운영 리스크 최소화 | [RFC-006](decisions/RFC-006_automated_deployment_verification.md)<br>[Deploy Workflow](../../.agent/workflows/deploy-production.md) |
| **2026-01-29** | **2.21** | **Market Intelligence & Rotation (Pillar 8)**<br>- 수급/공매도 분석 기반 '순환매 탐지' 로드맵 신설<br>- KIS Investor/Short Selling TR 명세 및 DB 스킨마 확정 | [Pillar 8](../strategy/master_roadmap.md)<br>[ISSUE-048](../issues/ISSUE-048.md) |
| **2026-01-30** | **2.22** | **Advanced Data Pipeline (RFC-010)**<br>- 10단계 호가 스트리밍, Whale 감지, DB 압축<br>- **Process**: TDD 검증(Spec+Test+Mock) 후 승인 (Test-First) | [RFC-010](decisions/RFC-010_advanced_data_pipeline.md) |
