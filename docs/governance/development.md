...
1.  **[README.md](file:///home/ubuntu/workspace/stock_backtest/README.md)**: 전체 시스템 가속도(Velocity) 및 Pillar 상태 업데이트.
2.  **[master_roadmap.md](file:///home/ubuntu/workspace/stock_backtest/docs/strategies/master_roadmap.md)**: DoD 달성 여부 및 다음 단계 연결.
3.  **[test_registry.md](file:///home/ubuntu/workspace/stock_backtest/docs/testing/test_registry.md)**: 품질 게이트(Tier 1~3) 통과 증명.
4.  **[Experiment Registry](file:///home/ubuntu/workspace/stock_backtest/experiments/README.md)**: 모든 개별 실험 및 시뮬레이션 결과 영구 기록.
5.  **[Knowledge Base (INDEX)](file:///home/ubuntu/workspace/stock_backtest/docs/governance/knowledge_base.md)**: 세션 persistence 보장을 위한 기술 분석 및 의사결정 이력 허브.
