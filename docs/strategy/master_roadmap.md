...
- [x] **Pillar 0: Governance & Standards 강화** (Status: ✅ **COMPLETED** - 2026-01-23)
    - [x] `.ai-rules.md`- [Core Constitution (v2.18)](../../.ai-rules.md)
...
- [Observability Roadmap (New)](observability_roadmap.md)
    ...
    - [x] 거버넌스 이연 작업 레지스트리 (`deferred_work.md`) 구축 (v2.6)
    - [x] 통합 백로그 관리 체계 (`BACKLOG.md` SSoT) 수립 (v2.18)
...
- **Phase 2.5 (Doomsday Protocol)**: 장애 발생 시 자동 복구 전략 (Sentinel Trigger -> Auto Fallback). (✅ DONE)
  - *Related*: [ISSUE-003](../issues/ISSUE-003.md) (API Error Handling)
...
- **Phase 3 (Hybrid Ingestion Strategy)**: 🆕 **2026-01-14**
  ...
  - *Related*: [ISSUE-007](../issues/ISSUE-007.md) (WebSocket Manager), [ISSUE-012](../ARCHIVE/issues/ISSUE-012.md) (KIS Auth Fix ✅ DONE)
...
- **Phase 3D (Backend Integration)**: 🆕 **DEFERRED**
  ...
  - *Related*: [ISSUE-005](../issues/ISSUE-005.md) (Candle Service), [ISSUE-006](../issues/ISSUE-006.md) (Sector Service)
- **Phase 3E (Tick Streaming)**: 🆕 **CONDITIONAL** (Load Testing 필수)
  ...
  - *Related*: [ISSUE-008](../issues/ISSUE-008.md) (OrderBook), [ISSUE-009](../issues/ISSUE-009.md) (Execution)
...
| **Q2-B** | **Tick 스트리밍** (Phase 3B) + [Electron 앱](../specs/ui_design_master.md#11-electron-client-design-specs-phase-3-spec) | 실시간 시장 미시구조 모니터링 |
