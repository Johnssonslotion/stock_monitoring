...
## Acceptance Criteria
- [x] **VirtualExchange Adapter**: Implement an adapter that mimics the real broker API interface.
- [x] **Cost Model Engine**: Accurate calculation of KR/US taxes, broker commissions, and margin interest.
- [x] **Execution Simulation**: Logic to simulate order filling based on orderbook snapshots (limit/market orders) with configurable slippage.
- [x] **Database Schema**: Tables for `virtual_accounts`, `virtual_positions`, `virtual_orders` created.
